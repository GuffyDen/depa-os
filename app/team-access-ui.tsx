...
function PermissionEditor({ value, onChange }: { value: AccessProfile; onChange: (profile: AccessProfile) => void }) {
  ...
  return <div className="permission-editor">
    ...
    {ACTION_GROUPS.map((group) => value.modules[group.module] ? <details className="permission-block permission-group" open={group.module === "finance"} key={group.module}>
